...
public class GraphicUI extends JFrame implements UserInterface{
	...
	public GraphicUI(Game game) {
		...
		creditWindow.setTitle("VideoPoker - Set your credit");
		creditWindow.setContentPane(new JPanel());
		creditWindow.setLayout(new FlowLayout());
		
		JLabel alertCredit = new JLabel("Please insert your starting credit");
		creditWindow.add(alertCredit);
		
		TextField amountField = new TextField();
		amountField.setPreferredSize(new Dimension(100, 20));
		amountField.setMaximumSize(new Dimension(100, 20));
		amountField.setMinimumSize(new Dimension(100, 20));
		creditWindow.add(amountField);
		
		JButton submitCredit = new JButton("Start Game");
		submitCredit.addActionListener(new ActionListener(){
	      public void actionPerformed(ActionEvent e) {
	    	  String strValue = (String) amountField.getText();
	    	  try { 
	    		  int intValue = Integer.parseInt(strValue);
	    		  mGame.getPlayer().setCredit(intValue);
	    		  setVisible(true);
	    		  pCredit.setText("Credit: " + String.valueOf(mGame.getPlayer().getCredit()));
	    ...
	    Image bgResized = bg.getScaledInstance(910, 700, Image.SCALE_DEFAULT);
	    ...
	    winningsLabel.setPreferredSize(new Dimension(900, 300));
	    winningsLabel.setMaximumSize(new Dimension(900, 300)); 
	    winningsLabel.setMinimumSize(new Dimension(900, 300));
    	...
    	betsPanel.setPreferredSize(new Dimension(900, 25));
    	betsPanel.setMaximumSize(new Dimension(900, 25)); 
    	betsPanel.setMinimumSize(new Dimension(900, 25));
    	...
    	for(int i = -1; i < 5; i++){
    		...
    		betl.setPreferredSize(new Dimension( (i == -1)? 140:140, 30));
    		betl.setMaximumSize(new Dimension((i == -1)? 140: 140, 30)); 
    		betl.setMinimumSize(new Dimension((i == -1)? 140: 140, 30));
    		betl.setOpaque(true);
    		betsPanel.add(betl);
    	}
	    for( String s : iterable ){	 
	    	...
	    	handPrizesLabel.setPreferredSize(new Dimension(900, 25));
	    	handPrizesLabel.setMaximumSize(new Dimension(900, 25)); 
	    	handPrizesLabel.setMinimumSize(new Dimension(900, 25));
	    	...
	    	handPowerLabel.setPreferredSize(new Dimension(140, 30));
	    	handPowerLabel.setMaximumSize(new Dimension(140, 30)); 
	    	handPowerLabel.setMinimumSize(new Dimension(140, 30));
	    	...
	    	for(int it2 = 0; it2 < retArray.length ; it2++){
	    		...
	    		winningsTable[it][it2].setPreferredSize(new Dimension(140, 30));
	    		winningsTable[it][it2].setMaximumSize(new Dimension(140, 30)); 
	    		winningsTable[it][it2].setMinimumSize(new Dimension(140, 30));
	    ...
	    messagesPanel.setPreferredSize(new Dimension(910, 700));
	    messagesPanel.setMaximumSize(new Dimension(910, 700)); 
	    messagesPanel.setMinimumSize(new Dimension(910, 700));
	    ...
	    Image spotResized = spot.getScaledInstance(160, 225, Image.SCALE_DEFAULT);
	    ...
	    for(int i = 0; i < 5; i++){
	    	...
	    	cardsOuterpannel[i].setPreferredSize(new Dimension(160, 225));
	    	cardsOuterpannel[i].setMaximumSize(new Dimension(160, 225)); 
	    	cardsOuterpannel[i].setMinimumSize(new Dimension(160, 225));
	    ...
	    //Players credit
	    pCredit = new JLabel();
	    pCredit.setPreferredSize(new Dimension(160, 50));
	    pCredit.setMaximumSize(new Dimension(160, 50)); 
	    pCredit.setMinimumSize(new Dimension(160, 50));
	    Font font = pCredit.getFont();
	    Font boldFont = new Font(font.getFontName(), Font.BOLD, 15);
	    pCredit.setFont(boldFont);
	    buttonsPanel.add(pCredit);
	...
	public void displayHand(String[] hand) {
	    for(int i = 0; i < 5; i++){
	    	...
	    	Image cardResized = cardImg.getScaledInstance(160, 225, Image.SCALE_DEFAULT);
